...
const TRANSLATIONS = {
  ...
  bn: {
    ...
    btn_view_terms: "টার্মস দেখুন",
    btn_refresh_captcha: "রিফ্রেশ",
    btn_logout: "লগআউট",
    ...
    ph_captcha_answer: "ক্যাপচা উত্তর লিখুন",
    ...
    reset_sent: "পাসওয়ার্ড রিসেট লিংক আপনার ইমেইলে পাঠানো হয়েছে।",
    reset_email_only: "রিসেট লিংক ইমেইল থেকে খুলে এই ফর্ম ব্যবহার করুন।",
    error_token_new_password_required: "নতুন পাসওয়ার্ড প্রয়োজন।",
    error_reset_failed: "পাসওয়ার্ড রিসেট ব্যর্থ হয়েছে।",
    reset_success: "পাসওয়ার্ড আপডেট হয়েছে।",
    error_terms_required: "টার্মস এবং কন্ডিশন অবশ্যই গ্রহণ করতে হবে।",
